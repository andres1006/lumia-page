      ...
      <div className="relative z-10 h-full flex items-end">
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16">
          <div className="max-w-2xl">
            {/* Slogan con fondo oscuro y sombra */}
            <p
              className={`text-lg sm:text-xl md:text-2xl lg:text-3xl text-white  leading-relaxed max-w-xl transition-all duration-1000 delay-300 ${
                isVisible
            ...
            >
              <a
                ...
                className="inline-flex items-center font-semibold rounded-lg text-white transition-all duration-200 hover:text-yellow-300 text-base sm:text-lg px-4 py-2 hover:scale-105"
                style={{
                  fontFamily: "'Montserrat', sans-serif",
                  fontWeight: 700,
                  textShadow:
                    "2px 2px 4px rgba(0, 0, 0, 0.8), 0 0 15px rgba(255, 255, 255, 0.2)",
                }}
              >
                {cta1Text}
              </a>
